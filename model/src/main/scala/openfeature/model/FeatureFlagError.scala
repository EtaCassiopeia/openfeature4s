...
object FeatureFlagError {
  ...
  /** The remote provider refused the request because of an authentication or authorization failure. */
  ...
  /** The remote provider could not be reached at the network layer. */
  ...
  /** Classify a Throwable raised by an underlying provider into a typed FeatureFlagError. */
